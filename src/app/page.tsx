  ...
  return (
    <div className="flex flex-col gap-16 pb-20">
      ...
      <section id="projects" className="scroll-mt-24 space-y-6">
        ...
        {primaryProject && (
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Link href={`/projects/${primaryProject.id}`} className="group block relative rounded-2xl bg-zinc-900 border-2 border-zinc-800 p-6 md:p-10 hover:bg-zinc-800/80 hover:border-emerald-500/50 transition-all shadow-xl">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="relative flex flex-col gap-5">
                <div className="flex justify-between items-start">
                  ...
                  <div className="bg-emerald-500/10 p-2 rounded-full border border-emerald-500/20 text-emerald-400">
                    <ArrowRight className="group-hover:translate-x-1 transition-all h-5 w-5" />
                  </div>
                </div>
      ...
      <section id="deep-dive" className="scroll-mt-24 space-y-6 pt-6 border-t border-zinc-800/50">
        ...
        {/* Visual Preview */}
        <Link href={`/projects/skill-lighthouse#architecture`} className="group flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 bg-zinc-900 border border-zinc-800 rounded-xl p-6 md:p-8 hover:border-zinc-600 transition-all">
